...
if ( !class_exists('LdapAuthenticationPlugin') ) {
	...
	class LdapAuthenticationPlugin {
		...
		function add_admin_custom_css() {
			...
			wp_register_style('ldap-auth-extra', $style, array('colors'), $this->version);
		...
		function add_admin_script() {
			...
			wp_register_script('ldap-auth-extra', $script, array('jquery-ui-dialog'), $this->version);
		...
		function _reset_options() {
			$all_options = array_filter(array_keys((array)get_alloptions()), create_function('$target', 'return preg_match("/^LDAP_authentication_/", $target);'));
